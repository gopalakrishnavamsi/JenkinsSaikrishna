({
  ...
  setBreadcrumbDefaultValues: function (component) {
    var defaultBreadcrumbValues = [
      {
        label: $A.get('$Label.c.MapYourSalesforceObjects'),
        navigateTo: 'CLMMappedObjectsHome',
        type: 'component',
        index: '1'
      },
      {
        label: $A.get('$Label.c.MapNew'),
        navigateTo: '',
        type: 'component',
        index: '2'
      }
  ...
  setBreadcrumbEditObjectValues: function (component) {
    var editBreadcrumbValues = [
      ...
      { label: $A.get('$Label.c.EditObject'), navigateTo: '', type: 'component', index: '2' }
    ];
