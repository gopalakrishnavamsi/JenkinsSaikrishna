({
  getFieldMapping: function (component, optionModalParams) {
    ...
    if (optionModalParams.isChild) {
      var parentFieldMapping = objMapping.fieldMappings[optionModalParams.parentIndex];
      fieldMapping = parentFieldMapping.childFieldMappings[optionModalParams.fieldIndex];
    } else {
