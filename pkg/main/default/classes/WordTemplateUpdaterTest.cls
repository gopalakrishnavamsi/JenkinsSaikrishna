...
private class WordTemplateUpdaterTest {
	...
	static void test_convertFormat_currency() {
		...
		f3.dataType = 'CURRENCY';
		f3.currencyFormat = 'default';
		f3.dateFormat = 'df';

		Test.startTest();
		System.assertEquals('cf', WordTemplateUpdater.convertFormat(f1));
		System.assertEquals('cf', WordTemplateUpdater.convertFormat(f2));
		System.assertEquals(null, WordTemplateUpdater.convertFormat(f3));
		Test.stopTest();
	}
	...
	static void test_convertFormat_date() {
		...
		f5.dateFormat = 'df';
		WordTemplateUpdater.FieldV1 f6 = new WordTemplateUpdater.FieldV1();
		f6.dataType = 'TIME';
		f6.currencyFormat = 'cf';
		f6.dateFormat = 'default';

		Test.startTest();
		System.assertEquals('df', WordTemplateUpdater.convertFormat(f1));
		System.assertEquals('default', WordTemplateUpdater.convertFormat(f2));
		...
		System.assertEquals('default', WordTemplateUpdater.convertFormat(f6));

		Test.stopTest();
	}

	@IsTest
	static void test_describeSObject() {
		Test.startTest();
		System.assertEquals(null, WordTemplateUpdater.describeSObject(null));
		System.assertEquals(null, WordTemplateUpdater.describeSObject('  '));
		System.assertEquals(Schema.Account.getSObjectType().getDescribe(), WordTemplateUpdater.describeSObject('Account'));
		System.assertEquals(Lead.getSObjectType().getDescribe(), WordTemplateUpdater.describeSObject('lead'));
		System.assertEquals(Contact.getSObjectType().getDescribe(), WordTemplateUpdater.describeSObject('CONTACT'));
		Test.stopTest();
	}
	...
	@IsTest
	static void test_updateTemplate_blacklisted_fields() {
		String expected = '{"version":2,"name":"Account","label":"Account","fieldMappings":[{"type":"ROOT","path":[],"key":"Account","fields":[{"type":"CHILD_RELATIONSHIP","scale":null,"relationship":"RecordActions","relatesTo":"RecordAction","parentIdField":"RecordId","name":"RecordAction","matchType":null,"label":"Parent Record ID","isConditional":false,"isChildRelation":true,"format":null,"conditionalValue":null},{"type":"CURRENCY","scale":null,"relationship":null,"relatesTo":null,"parentIdField":null,"name":"AnnualRevenue","matchType":"Match","label":"Annual Revenue","isConditional":true,"isChildRelation":false,"format":"symbol","conditionalValue":"20"},{"type":"REFERENCE","scale":null,"relationship":"Owner","relatesTo":"User","parentIdField":"OwnerId","name":"Owner","matchType":null,"label":"Owner ID","isConditional":false,"isChildRelation":false,"format":null,"conditionalValue":null}],"depth":1},{"type":"CHILD_RELATIONSHIP","path":["RecordAction"],"key":"RecordAction","fields":[{"type":"INTEGER","scale":null,"relationship":null,"relatesTo":null,"parentIdField":null,"name":"Order","matchType":"Match","label":"Order","isConditional":true,"isChildRelation":false,"format":null,"conditionalValue":"orders"}],"depth":2},{"type":"REFERENCE","path":["Owner"],"key":"Owner","fields":[{"type":"STRING","scale":null,"relationship":null,"relatesTo":null,"parentIdField":null,"name":"Country","matchType":"NotMatch","label":"Country","isConditional":true,"isChildRelation":false,"format":null,"conditionalValue":"Russia"},{"type":"ADDRESS","scale":null,"relationship":null,"relatesTo":null,"parentIdField":null,"name":"Address","matchType":null,"label":"Address","isConditional":false,"isChildRelation":false,"format":null,"conditionalValue":null}],"depth":2}]}';
		GenTemplate__c t = new GenTemplate__c(
			ObjectMappings__c = '[{"objLabel":"Account","label":"Account","isPrimary":true,"fieldMappings":[{"matchType":null,"label":"RecordActions","isConditional":false,"isChildRelation":true,"dateFormat":"default","dataType":"","currencyFormat":"symbol","conditionalValue":null,"childFieldMappings":[{"matchType":"Match","label":"Order","isConditional":true,"isChildRelation":false,"dateFormat":"default","dataType":"INTEGER","currencyFormat":"symbol","conditionalValue":"orders","apiName":"Order"}],"apiName":"RecordAction"},{"matchType":"Match","label":"Annual Revenue","isConditional":true,"isChildRelation":false,"dateFormat":"default","dataType":"CURRENCY","currencyFormat":"symbol","conditionalValue":"20","childFieldMappings":[],"apiName":"AnnualRevenue"},{"matchType":"NotMatch","label":"Country","isConditional":true,"isChildRelation":false,"dateFormat":"default","dataType":"STRING","currencyFormat":"symbol","conditionalValue":"Russia","childFieldMappings":[],"apiName":"Owner.Country"},{"matchType":null,"label":"Address","isConditional":false,"isChildRelation":false,"dateFormat":"default","dataType":"ADDRESS","currencyFormat":"symbol","conditionalValue":null,"childFieldMappings":[],"apiName":"Owner.Address"},{"matchType":"NotMatch","label":"Last Viewed Date","isConditional":true,"isChildRelation":false,"dateFormat":"MMMM dd, yyyy","dataType":"DATETIME","currencyFormat":"symbol","conditionalValue":"March 28, 2020","childFieldMappings":[],"apiName":"LastViewedDate"}],"apiName":"Account"}]',
			TemplateType__c = null);
		...
		System.assertNotEquals(null, result);
		System.assertEquals(Gen.TYPE_WORD, result.TemplateType__c);
		System.assertEquals(expected, result.ObjectMappings__c);
	}
}
